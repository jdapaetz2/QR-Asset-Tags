...
| **D3B** — daily return-exceptions summary, secured schedule, missed-run catch-up, quiet-day behaviour | migration 0036 (0035 went to the tag-request internal-column fix), first scheduled job | not started |
